$(document).ready(function() {
    ...
    $("#contact-form [type='submit']").click(function(e) {
        ...
        $('#valid-form').html('<span>Enviando <i class="fa fa-spinner fa-pulse fa-fw"></i></span>'); // Message displayed in the submit button during the sending
        ...
        $.post('php/contact-me.php', post_data, function(response){  
            ...
            if(response.type == 'error') {
                ...
                $('#valid-form').html('<span>Enviar</span>'); // Message displayed in the submit button if an error has occured
                ...
                $('#valid-form').html('<span>Enviado!</span>'); // Message displayed in the submit button when the submission is successfull
                ...
                window.setTimeout(function(){
                    $('#valid-form').html('<span>Enviar Mensaje</span>'); // Getting back to original button after successful submission
                },4000);
            }
